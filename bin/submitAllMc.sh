...
# Set the script file
script=$WORKDIR/bin/makeAllMc.sh
...
Notification            = Error
Executable              = $script
Arguments               = $CONFIG $VERSION $TASK $gpack
Rank                    = Mips
GetEnv                  = False
Input                   = /dev/null
